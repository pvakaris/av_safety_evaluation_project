...
from crdesigner.ui.gui.mwindow.top_bar_wrapper.service_layer.file_actions import _open_path
...
class MWindow(QMainWindow, Ui_mainWindow):
    ...
    def __init__(self, path=None, first_points_list = None, second_points_list = None):
        super().__init__()
        ...
        self.animated_viewer_wrapper = AnimatedViewerWrapper(mwindow=self, first_points_list = first_points_list, second_points_list = second_points_list)
