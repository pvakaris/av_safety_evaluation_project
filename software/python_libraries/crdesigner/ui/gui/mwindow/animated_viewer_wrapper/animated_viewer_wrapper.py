...
class AnimatedViewerWrapper:
    ...
    def __init__(self, mwindow, first_points_list, second_points_list):
        self.cr_viewer = AnimatedViewer(mwindow, self.viewer_callback, first_points_list, second_points_list)
