...
class DynamicCanvas(FigureCanvas):
    ...
    # Plots two lists of points on the map        
    def plot_points(self, first_points_list, second_points_list):
        if first_points_list:
            for pair in first_points_list:
                self.ax.plot(pair[0], pair[1], marker="x", color="blue", zorder=21)
        if second_points_list:
            for pair in second_points_list:
                self.ax.plot(pair[0], pair[1], marker="x", color="red", zorder=21)
