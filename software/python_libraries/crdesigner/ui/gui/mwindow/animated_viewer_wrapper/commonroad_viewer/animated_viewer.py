...
class AnimatedViewer:
    def __init__(self, parent, callback_function, first_points_list, second_points_list):
        ...
        self.first_points_list = first_points_list
        self.second_points_list = second_points_list
        self.update_window()
    ...
    def plot_points(self):
        self.dynamic.plot_points(self.first_points_list, self.second_points_list)
    ...
    def update_window(self):
        ...
        #     self.dynamic.plot_points(self.list_of_points)